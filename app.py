...
# This code is based on https://github.com/whitphx/streamlit-webrtc-example/blob/main/app.py
# and https://blog.tensorflow.org/2021/05/next-generation-pose-detection-with-movenet-and-tensorflowjs.html
def main():
...
def app_pose_detection():
    ...
    class MoveNetProcessor(VideoProcessorBase):
        ...
        def recv(self, frame: av.VideoFrame) -> av.VideoFrame:
            ...
            return av.VideoFrame.from_ndarray(output_overlay, format="rgb24")

    webrtc_ctx = webrtc_streamer(
        key="object-detection",
        mode=WebRtcMode.SENDRECV,
        client_settings=WEBRTC_CLIENT_SETTINGS,
        video_processor_factory=MoveNetProcessor,
